...
export default {
  template: `
     ...
     <section class="filter-bar flex flex-column align-center">
          ...
          <button :class="{ 'side-selected': isSelected(7) }" class ="star-btn" @click="setFilter('stared')"><i class="fa-solid fa-star"></i><span v-show="isShow">Starred</span></button>
          ...
          <button :class="{ 'side-selected': isSelected(6) }" @click="setFilter('trash')"><i class="fa-regular fa-trash-can"></i><span v-show="isShow">Trash</span></button>
     </section>
